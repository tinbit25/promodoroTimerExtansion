...
const ControlButtons = ({
  ...
  className={`px-6 py-3 rounded-lg text-indigo-500 font-bold transition-all duration-300 transform hover:scale-105 
...
<button
  ...
  className="px-6 py-3 rounded-lg text-indigo-500 font-bold bg-gradient-to-r from-orange-300 to-orange-500 hover:bg-gradient-to-r hover:from-orange-500 hover:to-orange-300 transition-all duration-300 transform hover:scale-105 shadow-lg"
>
  Restart
</button>
